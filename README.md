...
The `koopmans` command line tool is automatically installed. It can be used from
...
[PyPI](https://pypi.org/project/koopmans/) with uv:

```console
$ uv pip install koopmans
```

or with pip:

```console
$ python3 -m pip install koopmans
```
-->
...
https://zenodo.org/account/settings/github/repository/elinscott/koopmans to see
...
1. Navigate to https://github.com/elinscott/koopmans/releases/new to draft a new
   release
