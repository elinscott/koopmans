...
def install_pseudo_family(pseudo_family: str) -> None:
    ...
    if parts[0] == "PseudoDojo" and len(parts) == 6:
        ...
        raise ValueError(
            ...
            "-F pseudo.family.cutoffs\n"
            f"    aiida-pseudo family cutoffs set {pseudo_family} <cutoffs.json>\n"
            "Both steps are needed: the calculations take ecutwfc and ecutrho from the "
            "family's recommended cutoffs.\n"
