...
3. Declare the chain's codes as a TypedDict in `aiida-koopmans2/workgraphs/codes.py`; the route loads it via `load_chain_codes` in [aiida/workflows/](src/koopmans/aiida/workflows/__init__.py).
